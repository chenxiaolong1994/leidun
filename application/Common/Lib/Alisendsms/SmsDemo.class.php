<?php
namespace Common\Lib\Alisendsms;
ini_set("display_errors", "on");

require_once dirname(__DIR__) . '/Alisendsms/api_sdk/vendor/autoload.php';
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = C('alidayu_app_key'); // AccessKeyId

        $accessKeySecret = C('alidayu_app_secret'); // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($tel, $rand_code) {
        ...
        $request->setSignName(C('smsFreeSignName'));

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode(C('smsTemplateCode'));
